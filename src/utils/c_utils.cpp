...
map<int, C_utils::Metrics> C_utils::report(VectorXi &test, VectorXi &predicted, bool print){
  map<pair<int, int>, int> confusionMatrix = confusion_matrix(test, predicted, false);
  return report(confusionMatrix, print);
}

map<int, C_utils::Metrics> C_utils::report(VectorXi &test, VectorXd &predicted, bool print){
  map<pair<int, int>, int> confusionMatrix = confusion_matrix(test, predicted, false);
  return report(confusionMatrix, print);
}

map<int, C_utils::Metrics> C_utils::report(VectorXd &test, VectorXd &predicted, bool print){
  map<pair<int, int>, int> confusionMatrix = confusion_matrix(test, predicted, false);
  return report(confusionMatrix, print);
}

map<int, C_utils::Metrics> C_utils::report(map<pair<int, int>, int> confusionMatrix, bool print){
  map<int, double> precision = precision_score(confusionMatrix);
  ...
  map<int, C_utils::Metrics> report;
